...
">
	...
	<SETUP-CARDS>
	<PUTB ,F-CARD-TABLE 0 7>	;"nought of "
	<PUTB ,F-CARD-TABLE 1 10>	;"mazes"
	<PUTB ,F-CARD-TABLE 2 16>	;"hourglass"
	<PUTB ,F-CARD-TABLE 4 11>	;"trebled "
	<PUTB ,F-CARD-TABLE 5 15>	;"fromps"
	<PUTB ,F-CARD-TABLE 6 0>	;"back of card"
	<PUTB ,F-CARD-TABLE 8 8>	;"infinity of "
	<PUTB ,F-CARD-TABLE 9 5>	;"ears"
	<SETUP-FANUCCI>
	<SCREEN ,S-FULL>
	<CURSET 1 1>
	<INPUT 1 ,SLIDE-SHOW-TIMEOUT ,SLIDE-SHOW-HANDLER>
...
solemnly at the assembled guests. \"The king is dead!\"" CR>
		...
		<DIROUT ,D-SCREEN-OFF>
	 	<TELL "Y"> ;"so transcript doesn't say OU WAKE ON A HARD..."
	 	<DIROUT ,D-SCREEN-ON>
		<TELL
...
<ROUTINE G-DIMWIT-F (TBL F "AUX" X)
	 <COND (<EQUAL? <FIND-NOUN .F> ,W?PAINTING>
		<COND (<IN? ,LANDSCAPE ,HERE>
		       ,LANDSCAPE)
		      (T
		       ,PAINTINGS-1)>)
	       (<EQUAL? <FIND-NOUN .F> ,W?PORTRAIT>
		,PAINTINGS-1)
	       (<EQUAL? <FIND-NOUN .F> ,W?FLATHEAD>
		<COND ;(<EQUAL? ,HERE ,GALLERY>
		       ,PAINTINGS-1)
		      (<AND <SET TBL <FIND-ADJS .F>>
			    <SET X <ADJS-COUNT .TBL>>
			    <INTBL? ,W?DIMWIT <REST-TO-SLOT .TBL ADJS-COUNT 1> .X>>
		       ,DIMWIT)
		      (T
		       ,PAINTINGS-1)>)
	       (<EQUAL? <FIND-NOUN .F> ,W?STATUE>
		<COND (<RUNNING? ,I-PROLOGUE>
		       ,DIMWIT-STATUE)
		      (T
		       <RFALSE>)>)
...
<OBJECT MEGABOZ
	...
	(ADJECTIVE GAUNT BEARDED OLD ANGRY)
